...
// making notes service a singleton
  ...
  Future<DatabaseNote> updateNote({
    ...
    final updatesAccount = await db.update(noteTable, {
      textColumn: text,
  ...
  Future<void> _ensureDbIsOpen() async {
    try {
      await open();
    } on DatabaseAlreadyOpenAuthExpection {
      // empty
    }
  }
  ...
  Future<void> open() async {
    if (_db != null) {
      throw DatabaseAlreadyOpenAuthExpection();
    }
    try {
...
class DatabaseNote {
  ...
  @override
  String toString() =>
      'Notes, ID = $id, userId = $userId, isSynchedWithCloud = $isSynchedWithCloud, text = $text';
